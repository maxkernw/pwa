...
const http = new HttpService("https://api.github.com")
const defaultQuery = "elm";
...
const query = ($event) => $event.keyCode === 13 && $event.target.id === "query" 
        ? dispatch('fetch', $event.target.value) 
        : null;
